...
public class CameraMainActivity extends AppCompatActivity implements CameraXConfig.Provider{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonrecent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CameraMainActivity.this,ImageSelectActivity.class);
                        ...
                        new ImageCapture.OnImageSavedCallback() {
                            ...
                            public void onImageSaved(ImageCapture.OutputFileResults outputFileResults) {
                                ...
                                if(mImageUri!=null)
                                {
                                    ...
                                    Intent goToImageSend = new Intent(CameraMainActivity.this, ChatImage.class);
